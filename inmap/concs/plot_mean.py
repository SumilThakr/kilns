...
# Load the shapefile
shapefile_path = "../inputs/clipped_mean.shp"
...
gdf.plot(
    ...
    legend=True,
    ax=ax,
    legend_kwds={"label": "PM2.5 concentrations (µg/m³)"}
)
...
# Save output
plt.savefig("../outputs/maps/plot_mean_emis_concentrations.png", dpi=300, bbox_inches='tight')
plt.show()
